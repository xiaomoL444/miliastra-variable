export type KnownParamType = "String" | "StringList" | "Int32" | "Int32List" | "Float" | "FloatList" | "Bool" | "BoolList" | "Vector3" | "Vector3List" | "Entity" | "EntityList" | "Guid" | "GuidList" | "ConfigReference" | "ConfigReferenceList" | "EntityReference" | "EntityReferenceList" | "Army" | "ArmyList" | "Struct" | "StructList" | "Dict";
...
export type VariableIssueKind = "type-mismatch" | "struct-id-mismatch" | "missing-field" | "extra-field";
...
export type VariableValueData = unknown | VariableObjectValue | import("./variable-value.js").VariableValue[] | VariableDictEntryValue[];
